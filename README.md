# Forked version of MemoNet 
- Addition of a script "install.sh" that creates the needed virutal environment
- Modification of some lines in several files in order for it to run 
